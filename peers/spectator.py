...
class Spectator(BasePeer):
    ...
    def start(self, host_ip: str, host_port: int):
        ...
        # wait for connection (if not P2P, assume connected automatically)
        while not self.connected and host_ip != "255.255.255.255":
            time.sleep(0.1)
